...
const leftEyeGeometry = new THREE.SphereGeometry(.5, 32, 16)
const leftEyeMaterial = new THREE.MeshNormalMaterial()
const leftEye = new THREE.Mesh(leftEyeGeometry, leftEyeMaterial)
leftEye.position.set(6, 2, 1)
leftEye.castShadow = true
scene.add(leftEye)

const rightEyeGeometry = new THREE.SphereGeometry(.5, 32, 16)
const rightEyeMaterial = new THREE.MeshNormalMaterial()
const rightEye = new THREE.Mesh(rightEyeGeometry, rightEyeMaterial)
rightEye.position.set(6, 2, -1)
rightEye.castShadow = true
scene.add(rightEye)

const smileGeometry = new THREE.TorusGeometry( 1, .25, 16, 100, 3.14159265359 ) 
